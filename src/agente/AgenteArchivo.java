...
public class AgenteArchivo extends GuiAgent {
	private static final long serialVersionUID = 2416091915857024425L;
	...
	protected void onGuiEvent(GuiEvent ge) {
		...
		try {
			...
			msg.setContent(convertir(file));// se le añade el contenido al objeto de tipo mensaje, convirtiendo el
											// Buffer en un String
			msg.addReceiver(new AID("dm", AID.ISLOCALNAME));// AID= Agent identification, se le añade a quien se le
															// envia
	...
	/* Se definen los comportamiento del agente */
